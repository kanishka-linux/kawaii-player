...
**Note:** Even though, the application was initially only developed for gnu/linux systems, but it is possible to install it on any operating system which supports installation of python 3.5+ and pyqt5 5.5+.
